...
public class ConferenceIT extends AbstractExampleBase {
  ...
  public ConferenceIT(TestDevice testDevice) {
    super(testDevice);
  }
  ...
  public void verificationTest() {
    loadStartUrl();
    verify(
        new CurrentUrlVerification("Conference"),
        new PageTitleVerification("Conference"),
